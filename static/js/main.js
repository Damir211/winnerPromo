...
var odometerContainer = document.getElementById('odometer');
var randomButton = document.getElementById('button');
var winnerContainer3 = document.getElementById('winner-container-3');
var winnerContainer2 = document.getElementById('winner-container-2');
var winnerContainer1 = document.getElementById('winner-container-1');
var winnerId3 = document.getElementById('winner-id-3');
var winnerId2 = document.getElementById('winner-id-2');
var winnerId1 = document.getElementById('winner-id-1');
var odometerScript;

if (odometerContainer !== null && typeof odometerContainer !== 'undefined') {
  odometerScript = new Odometer({
    el: odometerContainer,
    value: '000000',
    format: 'd',
    minIntegerLen: 6
  });
...
function setValueOneWinner(winner) {
  odometerContainer.classList.remove('fill');
  randomButton.classList.add('hide');
  odometerScript.update(String(winner));
  setTimeout(function () {
    odometerContainer.classList.add('fill');
  }, 8500);
  setTimeout(function () {
    odometerContainer.classList.add('scale');
  }, 9000);
}

function setValueWinners(winner1, winner2, winner3) {
  winnerContainer3.classList.add('hide');
  winnerContainer2.classList.add('hide');
  winnerContainer1.classList.add('hide');
  winnerContainer1.classList.remove('animation');
  randomButton.classList.add('hide');
  odometerScript.update(String(winner3));
  setTimeout(function () {
    winnerId3.innerText = winner3;
    winnerContainer3.classList.remove('hide');
  }, 8500);
  setTimeout(function () {
    odometerScript.update(String(winner2));
  }, 9000);
  setTimeout(function () {
    winnerId2.innerText = winner2;
    winnerContainer2.classList.remove('hide');
  }, 17500);
  setTimeout(function () {
    odometerScript.update(String(winner1));
  }, 18000);
  setTimeout(function () {
    winnerId1.innerText = winner1;
    winnerContainer1.classList.remove('hide');
  }, 26500);
  setTimeout(function () {
    winnerContainer1.classList.add('animation');
  }, 27000);
  setTimeout(function () {
    winnerContainer1.classList.add('animation2');
  }, 27500);
  setTimeout(function () {
    winnerContainer1.classList.add('animation3');
  }, 28000);
}
